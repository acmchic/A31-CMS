...
class ApprovalWorkflowServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        // Register services
        $this->app->singleton(\Modules\ApprovalWorkflow\Services\ApprovalService::class);
        $this->app->singleton(\Modules\ApprovalWorkflow\Services\PdfGeneratorService::class);
    }
