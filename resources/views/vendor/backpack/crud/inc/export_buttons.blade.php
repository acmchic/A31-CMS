@if ($crud->exportButtons())
  @basset(asset('vendor/datatables/buttons.bootstrap5.min.css'))
  @basset(asset('vendor/datatables/dataTables.buttons.min.js'))
  @basset(asset('vendor/datatables/buttons.bootstrap5.min.js'))
  @basset(asset('vendor/jszip/jszip.min.js'))
  @basset(asset('vendor/pdfmake/pdfmake.min.js'))
  @basset(asset('vendor/pdfmake/vfs_fonts.js'))
  @basset(asset('vendor/datatables/buttons.html5.min.js'))
  @basset(asset('vendor/datatables/buttons.print.min.js'))
  @basset(asset('vendor/datatables/buttons.colVis.min.js'))
  <script>
