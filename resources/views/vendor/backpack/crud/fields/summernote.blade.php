...
@push('crud_fields_styles')
    ...
    @basset(asset('vendor/summernote/summernote-lite.min.css'))
    @basset(asset('vendor/summernote/summernote.woff2'), false)
...
@push('crud_fields_scripts')
    ...
    @basset(asset('vendor/summernote/summernote-lite.min.js'))
