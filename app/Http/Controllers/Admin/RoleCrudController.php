...
class RoleCrudController extends BaseRoleCrudController
{
    ...
    private function getGroupedPermissionOptions()
    {
        ...
        $groups = [
            ...
            'vehicle_management' => '🚗 Quản Lý Phương Tiện',
            'approval_center' => '✅ Trung Tâm Phê Duyệt',
            'reports' => '📈 Báo Cáo',
            'employee_management' => '👤 Quản Lý Nhân sự',
        ...
        $groupedPermissions = [
            ...
            'leave_management' => ['approve leaves', 'approve-leave-request', 'reject-leave-request', 'view-leave-request', 'view_leave_request', 'leave.approve', 'leave.review', 'leave.review.officer'],
            'vehicle_management' => ['manage vehicles', 'assign vehicles', 'view vehicle requests', 'approve vehicle step2', 'vehicle_registration.approve'],
            'approval_center' => ['approval_center.view'],
